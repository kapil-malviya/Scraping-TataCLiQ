...
for i in range(0, 250):
    ...
    if response.returncode == 0:
        ...
        if 'searchresult' in data:
            ...
            with open("jeans_for_men.csv", "a", newline='', encoding="utf-8") as csvfile:
